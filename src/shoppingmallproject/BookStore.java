 ...
 * @author 
 */
public class BookStore extends javax.swing.JFrame implements ActionListener,Store{

    Shopping shopping;
    /** Creates new form BookStore */
    public BookStore(Shopping shopping)
    {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Fictional Books");

        jLabel3.setText("Engineering Books");

        jLabel4.setText("Medical Books");

        jLabel5.setText("Others");

        jList1.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Fifty Shades", "The Lucky1", "Parallel Universe", "The Big Bang", "Game Theory" };
        ...
        jList2.setModel(new javax.swing.AbstractListModel() {
            String[] strings = {"S.L Loney","I.E Irodov","Circuit Theory","DataStructure & algorithm","Microprocessor"};
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        ...
        jList3.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Pathology & Microbiology", "Medicine", "Radiology", "Microbiology", "Neurology" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        ...
        jList4.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "5 point Someone", "Time to kill", "Haspiness never ends", "Life is too short", "Unforgiven" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
    ...
    public void actionPerformed(ActionEvent e) 
    {
            if(e.getSource()==jButton1)
            {
                ...
                fill(select3,jList3);
                fill(select4,jList4);
                shopping.updateText(s5, s6, "book");
