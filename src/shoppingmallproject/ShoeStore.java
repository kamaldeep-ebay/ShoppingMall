 ...
 * @author 
 */
public class ShoeStore extends javax.swing.JFrame implements ActionListener,Store{

    Shopping shopping;
    /** Creates new form BookStore */
    public ShoeStore(Shopping shopping) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ADDIDAS GAMES");

        jLabel3.setText("NIKE GAMES");

        jLabel4.setText("REEBOK GAMES");

        jLabel5.setText("WOODLAND");

        jList1.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "TENNIS SPONGY", "Sporty Football", "Regular_joggy", "Hard sole spiked", "ROBSLIM" };
        ...
        jList2.setModel(new javax.swing.AbstractListModel() {
            String[] strings = {"TENNIS_regular","7-Starred tough","Never runned","7 angled rough","SHANKy regular"};
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        ...
        jList3.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "NiKe_tennis", "Nike_cricket", "Nike_football", "Nike_gym", "Nike_regular" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        ...
        jList4.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "SUPER tough", "WARhard soled", "conica ASPHALT", "Speed getter", "STREET Walker" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
    ...
    public void actionPerformed(ActionEvent e) 
    {
            if(e.getSource()==jButton1)
            {
                ...
                fill(select3,jList3);
                fill(select4,jList4);
                shopping.updateText(s5, s6, "shoe");
